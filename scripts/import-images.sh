...
echo ""
echo "🔒 PRIVACY NOTE: Run 'npm run process-images' to strip EXIF metadata"
echo "   (GPS, camera info, timestamps) before committing. This happens"
echo "   automatically during 'npm run build' as well."
echo ""
